...
source $XDG_DATA_HOME/zsh/plugin/zsh-git-prompt/zshrc.sh
autoload -U colors && colors	# Load colors
PROMPT='%B%F{cyan}%~%f $(git_super_status) %F{yellow}>>%f %b'

# Enable colors and change prompt:
#PROMPT="%B%{$fg[red]%}[%{$fg[yellow]%}%n%{$fg[green]%}@%{$fg[blue]%}%M %{$fg[magenta]%}%~%{$fg[red]%}]%{$reset_color%}%b $(git_super_status)$ %b"
...
# plugins=(git-prompt zsh-syntax-highlighting zsh-autosuggestions zsh-vim-mode)
